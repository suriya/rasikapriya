...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concert.aware_start_time'
        db.add_column(u'rasikapriya_concert', 'aware_start_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=timezone.now()),
                      keep_default=False)

        # Adding field 'Concert.aware_end_time'
        db.add_column(u'rasikapriya_concert', 'aware_end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concert.aware_start_time'
        db.delete_column(u'rasikapriya_concert', 'aware_start_time')

        # Deleting field 'Concert.aware_end_time'
        db.delete_column(u'rasikapriya_concert', 'aware_end_time')
    ...
    models = {
        ...
        u'rasikapriya.concert': {
            ...
            'aware_end_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'aware_start_time': ('django.db.models.fields.DateTimeField', [], {}),
